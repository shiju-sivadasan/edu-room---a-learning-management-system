	...
	<main class="ttr-wrapper">
		<div class="container-fluid">
			...
			<div class="row">
								...
								<div class="card-courses-list admin-courses">
									...
									<div class="card-courses-full-dec">
										...
										<div class="row card-courses-dec">	                                    	
											 <div class="col-md-12">
											 <form method="post" action="action/post_cmntan.php" >
												<label>Comment</label>
				...
				<div class="col-md-12">
                    <a href="user_video_view.php<?php echo '?name='.$cname;?>" class="btn red radius-xl outline pull-right" style="width:160px;">Back</a>
                </div> 
