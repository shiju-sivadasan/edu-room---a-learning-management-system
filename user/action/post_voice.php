<?php
	...
	$file = $_FILES["file"]["name"];
		...
		$sql = "insert into user_post(Log_Id,name,sex,age,cntno,photo,cname,subj,ctgry,descp,file,date,status,ptype,cmntid)values('$Log_Id','$name','$sex','$age','$cntno','$photo','$cname','$subj','$ctgry','$descp','$file','$date','$status','$ptype','$cmntid')";
		$q1 = $db->prepare($sql);
		$q1->execute();	
