<?php
	...
	if($qst==$answr)
	{
		...
		$tot=$umrk+$mrk;
		$sql = "insert into contestattend(Log_Id,sname,name,mrk,date,photo)values('$Log_Id','$sname','$ssname','$tot','$date','$sphoto')";
		$q1 = $db->prepare($sql);
		$q1->execute();	
		header("location: ../contest_start2.php?sname=$sname");
