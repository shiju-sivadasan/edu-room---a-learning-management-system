<?php
	...
	$sname=$_GET["sname"];
	$result = $db->prepare("select * from contest where sname='$sname' and qno='1'");
	$result->execute();
						...
						<div class="widget-inner">
							<div class="card-courses-list admin-courses">
								...
								<div class="card-courses-full-dec">
                                    ...
                                    <?php
										$qry= $db->prepare("SELECT * FROM contestattend WHERE sname='$sname' AND Log_Id='$Log_Id'");
										$qry->execute();
										$count = $qry->rowcount();
										if($count > 0) 
										{		
                                 ...
                                 <!-- Start -->           
									<div class="card-courses-list-bx">
                                        ...
                                        <form method="get" action="action/contest_start1.php">
                                            <div class="row">
                                                <div class="col-6">
