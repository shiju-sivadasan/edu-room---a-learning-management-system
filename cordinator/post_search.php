			...
			<div class="row">
				...
				<div class="col-lg-12 m-b30">
					<div class="widget-box">
						<div class="wc-title">
							<h4><?php echo $ptype;?> Post List</h4>
						</div>
                        <!-- Start -->
                        <?php
                        $result = $db->prepare("select * from user_post where status='Pending' and Log_Id='$Log_Id' and ptype='$ptype' order by date desc");
                        $result->execute();
							...
							<div class="card-courses-list admin-courses">
								...
								<div class="card-courses-full-dec">
									<div class="card-courses-title">
										<h4><?php echo $ptype." ".$rows['cname'];?></h4>
									</div>
