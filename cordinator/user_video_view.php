			...
			<div class="row">
				...
				<div class="col-lg-12 m-b30">
					<div class="widget-box">
                        ...
                        <!-- Start -->
                        <?php
                        $result = $db->prepare("select * from user_post where status='Accept' and Log_Id!='$Log_Id' and cname like'%".$name."%' and ptype='Video'  and depart='$depart' order by ptype asc");
                        $result->execute();
							...
							<div class="card-courses-list admin-courses">
								...
								<div class="card-courses-full-dec">
									...
									<div class="row card-courses-dec">	
                                        ...
                                        <div class="col-md-3">
											<a href="user_video_comment.php<?php echo '?pst_id='.$rows['pst_id'];?>" class="btn green radius-xl outline pull-right" style="width:160px;">Comment</a>
										</div> 									
