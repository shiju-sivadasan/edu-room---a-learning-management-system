			...
			<div class="row">
				...
				<div class="col-lg-12 m-b30">
					<div class="widget-box">
                        ...
                        <!-- Start -->
                        <?php
                        $result = $db->prepare("select * from user_post where status='Accept' and cname like'%".$name."%' and ptype='PDF' order by ptype asc");
                        $result->execute();
							...
							<div class="card-courses-list admin-courses">
								...
								<div class="card-courses-full-dec">
									...
									<div class="row card-courses-dec">	
                                    	<div class="col-md-12">
											<iframe src="../post/<?php echo $rows['file'];?>" style="width:100%; height:100px; border-radius:5px;">
