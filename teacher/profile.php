		...
		<form class="edit-profile m-b30" method="post" action="action/profile_update.php" enctype="multipart/form-data">
								<div class="row">
									...
									<div class="form-group col-6">
										...
										<div>
                                        	<input class="form-control" type="text" name="depart"  value="<?php echo $depart;?>" readonly>                                       
										</div>
									</div>
                                    <div class="form-group col-6">
										<label class="col-form-label">Experience</label>
										<div>
											<input class="form-control" type="text" name="expr"  value="<?php echo $expr;?>" readonly>
										</div>
									</div>
									<div class="form-group col-6">
										<label class="col-form-label">Designation</label>
										<div>
											<input class="form-control" type="text" name="desig"  value="<?php echo $desig;?>" readonly>
										</div>
									</div>
                                    <div class="form-group col-6">
										<label class="col-form-label">Qualification</label>
										<div>
											<input class="form-control" type="text" name="quali"  value="<?php echo $quali;?>" readonly>
										</div>
									</div>
									<div class="form-group col-6">
