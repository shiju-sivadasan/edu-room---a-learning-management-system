		...
		<div class="container-fluid">
                     ...
                     <a href="user_material.php" style="color:white;">				 
						<div class="wc-item">
							...
							<span class="wc-stats">
                            	<span class="counter">
									<?php
                                        $result = $db->prepare("select count(*) from user_post where ptype='Material'");
                                        $result->execute();
                      ...
                      <a href="user_video.php" style="color:white;">						 
						<div class="wc-item">
							...
							<span class="wc-stats counter">
								<span class="counter">
									<?php
                                        $result = $db->prepare("select count(*) from user_post where ptype='Video'");
                                        $result->execute();
                                        for($i=0; $row = $result->fetch(); $i++)
                                        {
                                            echo"".$row['count(*)']."";
					...
					<div class="widget-card widget-bg3">	
						...
						<div class="wc-item">
							...
							<span class="wc-stats counter">
								<span class="counter">
									<?php
                                        $result = $db->prepare("select count(*) from user_post where ptype='Voice'");
                                        $result->execute();
                                        for($i=0; $row = $result->fetch(); $i++)
                                        {
                                            echo"".$row['count(*)']."";
                      ...
                      <a href="feedback_view.php" style="color:white;">						 
						<div class="wc-item">
							...
							<span class="wc-stats counter">
								<span class="counter">
									<?php
                                        $result = $db->prepare("select count(*) from notification");
                                        $result->execute();
                                        for($i=0; $row = $result->fetch(); $i++)
                                        {
                                            echo"".$row['count(*)']."";
			...
			<div class="row">
				...
				<div class="col-lg-8 m-b30">
					<!-- Start -->
                        <?php
                        $result = $db->prepare("select * from user_post where status='Accept' order by ptype asc limit 1");
                        $result->execute();
